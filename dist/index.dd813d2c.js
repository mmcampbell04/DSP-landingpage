...
scrollLinks.forEach((link)=>{
    link.addEventListener("click", _navbar.getScrollHeight);
});
// testimonials slides
const slider = document.getElementById("range");
slider.addEventListener("change", _slider.getSliderRange);

},{"./colorTheme":"j1n6r","./navbar":"9Wr0X","./slider":"aBWaM"}],"j1n6r":[function(require,module,exports) {
...
parcelHelpers.export(exports, "getScrollHeight", ()=>getScrollHeight
);
